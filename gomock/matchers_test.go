...
//go:generate mockgen -destination internal/mock_gomock/mock_matcher.go github.com/neutrinocorp/mock/gomock Matcher
...
import (
	...
	"github.com/neutrinocorp/mock/gomock/internal/mock_gomock"
)
